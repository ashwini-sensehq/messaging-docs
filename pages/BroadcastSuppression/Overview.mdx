...
1. How to enable Broadcast Suppression
    ...
    ![Admin page](/AdminReleaseFlag.png)

    2. Go to Settings page and under role, select your role, options to set Broadcast Suppression. As Shown in the image below ![](/Settings.png)
...
## Broadcast Suppression Type - Forced / Admin Controlled
    ...
    ![Admin Controlled](/AdminControlled.png)
...
## Broadcast Suppression Type - Optional / Recruiter Controlled
    ...
    ![Recruiter Controlled](/RecruiterControlled.png)
    
    ![Edit Time Frame](/EditTimeFrame.png)
